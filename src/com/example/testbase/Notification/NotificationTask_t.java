...
public class NotificationTask_t extends Fragment implements View.OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(R.layout.notification_t, container, false); 
		rn=(Button)view.findViewById(R.id.releaseNotice);
		rn.setOnClickListener(new View.OnClickListener() {
			         public void onClick(View v) {
			        	 Intent intent = new Intent(getActivity(), ReleaseNotice.class);
	...
	try {
		...
		String sql="select * from notice where type= '任务提交'";
