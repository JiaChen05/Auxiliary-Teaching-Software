...
import com.example.testbase.My.FragmentMy_t;
import com.example.testbase.Notification.FragmentNotification;
import com.example.testbase.Notification.FragmentNotification_t;
import com.example.testbase.Task.FragmentTask;
import com.example.testbase.Task.FragmentTask_t;
...
public class MainTab_t extends FragmentActivity {
	private String TAG = MainTab_t.class.getName();
	...
	private Integer[] ImgTab = { R.layout.tab_notification_t,
			R.layout.tab_task_t, R.layout.tab_my_t };


	private Class[] ClassTab = { FragmentNotification_t.class, FragmentTask_t.class,
			 FragmentMy_t.class };
